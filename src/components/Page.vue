    ...
    <div class="container-fluid">
      <div class="navbar-brand pt-3 pb-2 mx-0 sticky-top">
        <div class="d-flex justify-content-between">
            <router-link to="/" class="mx-2 my-1">
                <img
                    src="../assets/img/gtr_academy-300x115.png"
                    alt="GTR Academy"
                />
            </router-link>
            <ul class="nav justify-content-end my-auto">
                <li class="nav-item">
                    <a class="nav-link active" href="javascript:;">Inicio</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link dropdown-toggle" data-toggle="dropdown" href="javascript:;" role="button" aria-haspopup="true" aria-expanded="false">Servicios</a>
                    <div class="dropdown-menu">
                    <a class="dropdown-item" href="javascript:;">Trading</a>
        ...
        <ul class="nav justify-content-end my-auto">
          ...
          <li class="nav-item">
            ...
            <div class="dropdown-menu">
              ...
              <a class="dropdown-item" href="javascript:;">Another action</a>
              <div class="dropdown-divider"></div>
              <a class="dropdown-item" href="javascript:;">Separated</a>
            </div>
          </li>
          <li class="nav-item">
            <a class="nav-link" href="javascript:;">Compañia</a>
          </li>
          <li class="nav-item">
            <a class="nav-link" href="javascript:;">Servicios</a>
          </li>
          <li class="nav-item">
            <a class="nav-link" href="javascript:;">Contacto</a>
          </li>
        </ul>
      </div>
      <!-- /.container-fluid -->
      ...
      <header>
        <!-- <div class="videobackground">
          <iframe
            width="720"
            height="405"
            src="https://www.youtube.com/embed/yUShkXpqgS0"
          ...
          <div class="row">
            <div class="col-md-6 intro-text">
              <div class="intro-heading">
                LA ACADEMIA DE LA ERA DIGITAL QUE TODOS QUIEREN INVERTIR
              </div>
            </div>
            <div class="col-md-6">
              <div class="d-block align-social">
                <a href="">
                  <i
                    class="col-md-12 col-sm-4 fab fa-2x my-2 text-dark fa-twitter"
                  ></i>
                </a>
                <a href="">
                  <i
                    class="col-md-12 col-sm-4 fab fa-2x my-2 text-dark fa-facebook-square"
                  ></i>
                </a>
                <a href="">
                  <i
                    class="col-md-12 col-sm-4 fab fa-2x my-2 text-dark fa-instagram"
                  ></i>
                </a>
              </div>
            </div>
          ...
          <div class="row">
            ...
            <div class="col-md-3 col-6">
              <ul class="nav">
                <li class="nav-item">
                  <a
                    href="https://creative-tim.com/contact-us?ref=blkdsp-footer"
                    class="nav-link"
                  >
                    Contact Us
                  </a>
                ...
                <li class="nav-item">
                  <a
                    href="https://creative-tim.com/about-us?ref=blkdsp-footer"
                    class="nav-link"
                  >
                    About Us
                  </a>
                ...
                <li class="nav-item">
                  <a
                    href="http://creative-tim.com/blog?ref=blkdsp-footer"
                    class="nav-link"
                  >
                    Blog
                  </a>
                ...
                <li class="nav-item">
                  <a
                    href="https://opensource.org/licenses/MIT?ref=blkdsp-footer"
                    class="nav-link"
                  >
                    License
                  </a>
            ...
            <div class="col-md-3">
              ...
              <div class="btn-wrapper profile text-left">
                ...
                <a
                  target="_blank"
                  href="https://www.fcebook.com/creativetim"
                  class="btn btn-icon btn-neutral btn-round btn-simple"
                  data-toggle="tooltip"
...
header {
  ...
  background-image: url("https://thumbs.dreamstime.com/b/summer-beach-background-seashells-57302038.jpg");
